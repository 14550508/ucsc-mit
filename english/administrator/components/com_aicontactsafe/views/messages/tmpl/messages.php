	...
	<tr><td>
		<table border="0" cellpadding="0" cellspacing="2">
			<tr>
				...
				<td>
					<input type="text" name="filter_email" id="filter_email" value="<?php echo $this->filter_email;?>" class="text_area" onchange="document.adminForm.submit();" title="<?php echo JText::_('COM_AICONTACTSAFE_FILTER_BY_EMAIL');?>"/>
				</td>
				<td>&nbsp;&nbsp;&nbsp;</td>
				<td>
				...
				<td>
					<input type="text" name="filter_subject" id="filter_subject" value="<?php echo $this->filter_subject;?>" class="text_area" onchange="document.adminForm.submit();" title="<?php echo JText::_('COM_AICONTACTSAFE_FILTER_BY_SUBJECT');?>"/>
				</td>
				<td>&nbsp;&nbsp;&nbsp;</td>
				<td>
