...
<?php $this->load->view('tpl/student_menu'); ?>
	...
	?>  
        ...
        <form class="form-horizontal" id="default" method="post" action="">  
			...
			<img src="http://nanatharana.com/dl/img/T RS.png" />
		...
		<?php foreach ($query2->result() as $rowQQ )
		{ 
		$qno +=1;
		?>
					   ...
					   <section class="panel">
                            ...
                            <div class="panel-body">
								...
								<div class="radios col-lg-12">
									<div> <label class="col-lg-6 control-label"><h5>Choose your answer / නිවරැදි පිළිතුර තොරන්න ?</h5></label></div>
