                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              <h3> Comparison of the Capacities of two Condensers </h3>
                          </header>
...
<img src="<?php echo base_url(); ?>img/phypracticals/electornic/viston.png" width="100%"/> 

 <div class="btn-group btn-group-justified">
                                    <div class="col-lg-4">&nbsp;</div>
                                    <div class="col-lg-8">
                                        
                                 <a class="btn btn-success" href="<?php echo base_url();?>practicals/vistonquiz">Next</a>
