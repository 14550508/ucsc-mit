                  ...
                  <aside class="profile-nav col-lg-3">
                      <section class="panel">
                          <div class="user-heading round" style="background:<?= $userdatas[0]->bgColor;?>">
                              <a href="#"> <?php if($userdatas[0]->stp_profile_pic =='' || $userdatas[0]->stp_profile_pic ==0){ ?> 
		...
		<?php } ?>
                              ...
                              <form class="form-horizontal" role="form" action="<?php echo base_url();?>students/profileEdit" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
                                          ...
                                          <div class="col-lg-6">
											...
											<div class="fileupload fileupload-new" data-provides="fileupload">
											  <span class="btn btn-white btn-file">
                                                <span class="fileupload-new"><i class="fa fa-paper-clip"></i> Change Profile Picture</span>
									     ...
									     <div class="form-group">
                                      <label class="control-label col-lg-2">Background Colour</label>
                                      <div class="col-md-4 col-xs-11">
                                            <div data-color-format="rgb" data-color="<?php echo $userdatas[0]->bgColor; ?>" class="input-append colorpicker-default color">
                                              <input type="text" readonly="" name="bgColor" value="<?php echo $userdatas[0]->bgColor; ?>" class="form-control">
