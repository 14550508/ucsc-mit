                      ...
                      <div id="quizzes">
                          ...
                          <section class="panel">
                              <div class="panel-heading">
                                <div class="row">
                                    <div class="col-md-4">    
                                         <span style="font-size: 18px; font-weight: 500"><i class="fa fa-check-square"> </i> Find Quizzes</span> 
                                    </div>
                                      <div class="col-md-4">
                                      <span class="pull-right">
                                        <div class="input-group ">                                              
                                              <input type="text" id="quizcat" class="form-control">
                                    ...
                                    <div class="col-md-4">
                                       <span class="pull-right">
                                        <div class="input-group ">                                              
                                              ...
                                              <input type="text" id="findQuiz" class="form-control" placeholder="Search by Keyword">
                                              <span class="input-group-btn">
